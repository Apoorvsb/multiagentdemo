...
PRODUCTS = [
    ...
    (
        "hd-bud-001",
        "Portronics Harmonics Z1 Wireless Earbuds 20H Battery",
        "Electronics",
        "Portronics",
        399,
        999,
    ...
    (
        "hd-bud-002",
        "Noise Shots X5 Pro TWS Earbuds Quad Mic ENC",
        "Electronics",
        "Noise",
        599,
        1499,
    ...
    (
        "hd-bud-004",
        "realme Buds T100 True Wireless Earbuds 28H Battery",
        "Electronics",
        "realme",
        799,
        1999,
    ...
    (
        "hd-neck-001",
        "Noise Tune Elite Wireless Neckband 60H Battery",
        "Electronics",
        "Noise",
        499,
        1299,
    ...
    (
        "hd-neck-002",
        "Boult Audio Bassbuds X1 Neckband Earphone 50H Battery",
        "Electronics",
        "Boult",
        399,
        999,
    ...
    (
        "hd-over-001",
        "Zebronics Zeb-Thunder Wireless Over Ear Headphone",
        "Electronics",
        "Zebronics",
        499,
        1299,
    ...
    (
        "hd-over-002",
        "Philips Audio TAH4205BK Over Ear Wireless Headphones",
        "Electronics",
        "Philips",
        999,
        2499,
    ...
    (
        "hd-anc-001",
        "Jabra Evolve2 55 UC Wireless Headset ANC",
        "Electronics",
        "Jabra",
        24999,
        32000,
    ...
    (
        "spk-001",
        "Amazon Echo Pop Compact Smart Speaker Alexa",
        "Electronics",
        "Amazon",
        2999,
        4999,
    ...
    (
        "spk-002",
        "boAt Stone 200 5W Bluetooth Speaker IPX5",
        "Electronics",
        "boAt",
        799,
        1999,
    ...
    (
        "spk-003",
        "JBL Flip 6 Waterproof Portable Speaker 12H",
        "Electronics",
        "JBL",
        9999,
        14999,
    ...
    (
        "spk-004",
        "Portronics Breeze 8 Wireless Speaker 10W",
        "Electronics",
        "Portronics",
        599,
        1499,
    ...
    (
        "spk-sb-001",
        "boAt Aavante Bar 1700D 120W Dolby Soundbar",
        "Electronics",
        "boAt",
        7999,
        14999,
    ...
    (
        "spk-sb-002",
        "Sony HT-S40R 5.1ch Real Surround Sound Soundbar",
        "Electronics",
        "Sony",
        18990,
        24990,
    ...
    (
        "tv-001",
        "Redmi 32 inch HD Ready Smart TV 2023",
        "Electronics",
        "Redmi",
        11999,
        16999,
    ...
    (
        "tv-003",
        "LG 55 inch OLED C3 4K Smart TV",
        "Electronics",
        "LG",
        129990,
        164990,
    ...
    (
        "tv-004",
        "TCL 50 inch 4K QLED Android TV C635",
        "Electronics",
        "TCL",
        37990,
        54990,
    ...
    (
        "tv-005",
        "VU 32 inch HD Smart TV GloLED Series",
        "Electronics",
        "VU",
        8999,
        14999,
    ...
    (
        "cam-001",
        "Canon EOS 1500D 24.1MP Digital SLR Camera",
        "Electronics",
        "Canon",
        29990,
        39990,
    ...
    (
        "cam-002",
        "Sony ZV-E10 Mirrorless Camera for Content Creators",
        "Electronics",
        "Sony",
        59990,
        74990,
    ...
    (
        "cam-003",
        "GoPro HERO12 Black Action Camera 5.3K",
        "Electronics",
        "GoPro",
        37990,
        44990,
    ...
    (
        "kb-001",
        "Zebronics Zeb-K16 USB Keyboard Slim",
    ...
    (
        "kb-002",
        "Portronics Hydra 10 Wireless Keyboard Mouse Combo",
        "Computers&Accessories",
        "Portronics",
        799,
        1999,
    ...
    (
        "kb-003",
        "Logitech MK275 Wireless Keyboard Mouse Combo",
        "Computers&Accessories",
        "Logitech",
        1795,
        2495,
    ...
    (
        "ms-001",
        "Zebronics Zeb-Comfort Wired Optical Mouse",
        "Computers&Accessories",
        "Zebronics",
        149,
        299,
    ...
    (
        "ms-003",
        "Logitech G102 Lightsync Gaming Mouse 8000 DPI",
        "Computers&Accessories",
        "Logitech",
        1495,
        2495,
    ...
    (
        "mon-b-001",
        "Zebronics ZEB-A22FHD LED Monitor 21.5 inch FHD",
        "Computers&Accessories",
        "Zebronics",
        5999,
        8999,
    ...
    (
        "mon-b-002",
        "AOC 22B2HM 21.5-inch FHD VA Monitor 75Hz",
        "Computers&Accessories",
        "AOC",
        7999,
        11999,
    ...
    (
        "mon-m-001",
        "LG 27MP400-B 27-inch FHD IPS Monitor 75Hz",
        "Computers&Accessories",
        "LG",
        14999,
        19999,
    ...
    (
        "mon-m-002",
        "Dell S2421HN 24-inch FHD IPS Monitor 75Hz",
        "Computers&Accessories",
        "Dell",
        13999,
        18499,
    ...
    (
        "mon-g-001",
        "Samsung Odyssey G5 27-inch WQHD 165Hz Curved",
        "Computers&Accessories",
        "Samsung",
        24999,
        34999,
    ...
    (
        "mon-g-002",
        "LG 27GN800-B UltraGear 27-inch WQHD 144Hz IPS",
        "Computers&Accessories",
        "LG",
        27999,
        36999,
    ...
    (
        "ssd-001",
        "WD Green 240GB 2.5-inch SATA SSD",
        "Computers&Accessories",
        "Western Digital",
        1699,
        2499,
    ...
    (
        "ssd-002",
        "Samsung 870 EVO 500GB 2.5-inch SATA SSD",
        "Computers&Accessories",
        "Samsung",
        4499,
        5999,
    ...
    (
        "ssd-003",
        "Samsung 980 Pro NVMe M.2 1TB PCIe 4.0 SSD",
        "Computers&Accessories",
        "Samsung",
        8999,
        13999,
    ...
    (
        "ssd-005",
        "Seagate BarraCuda 1TB Internal HDD 7200RPM",
        "Computers&Accessories",
        "Seagate",
        2999,
        3999,
    ...
    (
        "lap-bud-001",
        "HP 15s Intel Celeron N4500 4GB RAM 256GB SSD",
        "Computers&Accessories",
        "HP",
        25990,
        32990,
    ...
    (
        "lap-bud-002",
        "Acer Aspire Lite AMD Ryzen 3 5300U 8GB 256GB SSD",
        "Computers&Accessories",
        "Acer",
        29999,
        38999,
    ...
    (
        "wc-001",
        "Zebronics Zeb-Crystal Pro Full HD Webcam",
        "Computers&Accessories",
        "Zebronics",
        799,
        1999,
    ...
    (
        "wc-002",
        "Logitech C920s HD Pro Webcam 1080p 30fps",
        "Computers&Accessories",
        "Logitech",
        5995,
        7995,
    ...
    (
        "hub-001",
        "AmazonBasics USB 3.0 4-Port Hub",
        "Computers&Accessories",
        "Amazon",
        499,
        999,
    ...
    (
        "hub-002",
        "Portronics Mport 13 USB C Hub 7-in-1",
        "Computers&Accessories",
        "Portronics",
        1299,
        2999,
    ...
    (
        "af-001",
        "INALSA Air Fryer Tasty Fry 1400W 4.2L",
        "Home&Kitchen",
        "INALSA",
        2499,
        4999,
    ...
    (
        "af-002",
        "Philips Air Fryer HD9200 1400W 4.1L NA",
        "Home&Kitchen",
        "Philips",
        5995,
        8995,
    ...
    (
        "af-003",
        "Cosori Pro Air Fryer 5.5L 1700W Dual Blaze",
        "Home&Kitchen",
        "Cosori",
        7999,
        10999,
    ...
    (
        "af-004",
        "Instant Vortex 4-in-1 Air Fryer 5.7L 1500W",
        "Home&Kitchen",
        "Instant",
        5499,
        7999,
    ...
    (
        "af-005",
        "AGARO Regency Air Fryer 12L Oven 1800W",
        "Home&Kitchen",
        "AGARO",
        6999,
        9999,
    ...
    (
        "mx-001",
        "Bajaj GX 3 500W Mixer Grinder 3 Jars",
        "Home&Kitchen",
        "Bajaj",
        1299,
        2199,
    ...
    (
        "mx-003",
        "Sujata Dynamix DX 900W Mixer Grinder",
        "Home&Kitchen",
        "Sujata",
        3599,
        4999,
    ...
    (
        "mx-004",
        "Bosch TrueMixx Pro 1000W Mixer Grinder",
        "Home&Kitchen",
        "Bosch",
        5999,
        7999,
    ...
    (
        "pc-001",
        "Prestige Popular Aluminium Pressure Cooker 3L",
        "Home&Kitchen",
        "Prestige",
        599,
        999,
    ...
    (
        "pc-002",
        "Hawkins Contura Aluminium Pressure Cooker 3L",
        "Home&Kitchen",
        "Hawkins",
        999,
        1499,
    ...
    (
        "mw-001",
        "Samsung 23L Solo Microwave Oven MS23K3513AK",
        "Home&Kitchen",
        "Samsung",
        7490,
        9990,
    ...
    (
        "mw-002",
        "LG 28L Convection Microwave Oven MC2886BFUM",
        "Home&Kitchen",
        "LG",
        14990,
        19990,
    ...
    (
        "mw-003",
        "IFB 20L Solo Microwave 20PM MEC2B",
        "Home&Kitchen",
        "IFB",
        5490,
        7490,
    ...
    (
        "wp-001",
        "HUL Pureit Classic G2 Mineral RO+UV Water Purifier",
        "Home&Kitchen",
        "HUL Pureit",
        7999,
        11999,
    ...
    (
        "wp-002",
        "Kent Grand Plus 8L RO+UV+UF+TDS Water Purifier",
        "Home&Kitchen",
        "Kent",
        14999,
        19999,
    ...
    (
        "wp-003",
        "AO Smith Z8 10L UV+UF Wall Mounted Water Purifier",
        "Home&Kitchen",
        "AO Smith",
        5999,
        8999,
    ...
    (
        "bl-002",
        "Prestige Iris 550W Hand Blender",
        "Home&Kitchen",
        "Prestige",
        799,
        1499,
    ...
    (
        "jc-001",
        "Philips Viva Collection HR1855 Juicer 500W",
        "Home&Kitchen",
        "Philips",
        3495,
        4995,
    ...
    (
        "cf-001",
        "Morphy Richards New Europa 600W Coffee Maker",
        "Home&Kitchen",
        "Morphy Richards",
        1499,
        2499,
        ...
        with conn.cursor() as cur:
            ...
            for row in PRODUCTS:
                ...
                try:
                    ...
                    """,
                        [pid, name, cat, brand, price, orig, disc, rating, rcount, desc, True],
                    )
                    if cur.rowcount:
                        p_in += 1
                    else:
...
def verify():
    with get_conn() as conn:
        with conn.cursor() as cur:
            cur.execute(
                "SELECT category, COUNT(*), MIN(price), MAX(price) FROM products GROUP BY category ORDER BY category"
            )
            print("\nCategory breakdown:")
