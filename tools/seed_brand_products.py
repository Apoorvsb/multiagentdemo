...
PRODUCTS = [
    ...
    (
        "apple-006",
        "Apple MacBook Air M3 Chip 8GB RAM 256GB SSD 13-inch",
    ...
    (
        "apple-007",
        "Apple MacBook Air M3 Chip 8GB RAM 256GB SSD 15-inch",
        "Computers&Accessories",
        "Apple",
        134900,
        149900,
    ...
    (
        "apple-008",
        "Apple iPad Pro M4 11-inch 256GB Wi-Fi Space Black",
        "Electronics",
        "Apple",
        99900,
        109900,
    ...
    (
        "apple-009",
        "Apple iPad mini 6th Gen 64GB Wi-Fi Purple",
        "Electronics",
        "Apple",
        46900,
        52900,
    ...
    (
        "apple-010",
        "Apple Watch Ultra 2 with Alpine Loop",
        "Electronics",
        "Apple",
        89900,
        99900,
    ...
    (
        "apple-011",
        "Apple Watch SE 2nd Generation GPS 40mm Midnight Aluminium",
        "Electronics",
        "Apple",
        29900,
        34900,
    ...
    (
        "sam-s24-002",
        "Samsung Galaxy S24+ 5G 12GB RAM 256GB Marble Gray",
        "Electronics",
        "Samsung",
        99999,
        114999,
    ...
    (
        "sam-a55-001",
        "Samsung Galaxy A55 5G 8GB RAM 128GB Awesome Iceblue",
        "Electronics",
        "Samsung",
        38999,
        44999,
    ...
    (
        "sam-a35-001",
        "Samsung Galaxy A35 5G 8GB RAM 128GB Awesome Iceblue",
        "Electronics",
        "Samsung",
        30999,
        35999,
    ...
    (
        "sam-a15-001",
        "Samsung Galaxy A15 5G 4GB RAM 128GB Blue Black",
        "Electronics",
        "Samsung",
        15999,
        19999,
    ...
    (
        "sam-tab-001",
        "Samsung Galaxy Tab S9 FE 6GB RAM 128GB Gray Wi-Fi",
        "Electronics",
        "Samsung",
        34999,
        42999,
    ...
    (
        "sam-tab-002",
        "Samsung Galaxy Tab A9+ 8GB RAM 128GB Wi-Fi Graphite",
        "Electronics",
        "Samsung",
        24999,
        29999,
    ...
    (
        "sam-buds-001",
        "Samsung Galaxy Buds 2 Pro Active Noise Cancellation TWS Earbuds",
        "Electronics",
        "Samsung",
        12999,
        17999,
    ...
    (
        "sam-watch-001",
        "Samsung Galaxy Watch 6 Classic 43mm Bluetooth Black",
        "Electronics",
        "Samsung",
        32999,
        39999,
    ...
    (
        "sony-h-004",
        "Sony WH-CH520 Wireless Headphones 50 Hours Battery",
        "Electronics",
        "Sony",
        3990,
        5990,
    ...
    (
        "sony-e-001",
        "Sony WF-1000XM5 True Wireless Industry Leading Noise Cancelling Earbuds",
        "Electronics",
        "Sony",
        19990,
        27990,
    ...
    (
        "sony-e-002",
        "Sony WF-1000XM4 True Wireless Noise Cancelling Earbuds",
        "Electronics",
        "Sony",
        14990,
        22990,
    ...
    (
        "sony-e-003",
        "Sony LinkBuds S Truly Wireless Noise Cancelling Earbuds",
        "Electronics",
        "Sony",
        11990,
        16990,
    ...
    (
        "sony-e-004",
        "Sony WF-C700N Wireless Noise Cancelling Earbuds",
        "Electronics",
        "Sony",
        7990,
        11990,
    ...
    (
        "sony-e-005",
        "Sony WF-C500 Truly Wireless Headphones 20 Hours Battery",
        "Electronics",
        "Sony",
        4990,
        7990,
    ...
    (
        "hp-001",
        "HP Spectre x360 14 Intel Core Ultra 7 16GB RAM 1TB SSD 2-in-1 Laptop",
        "Computers&Accessories",
        "HP",
        164999,
        184999,
    ...
    (
        "hp-002",
        "HP Envy x360 14 AMD Ryzen 7 7730U 16GB RAM 512GB SSD 2-in-1 Laptop",
        "Computers&Accessories",
        "HP",
        89999,
        104999,
    ...
    (
        "hp-003",
        "HP Omen 16 AMD Ryzen 7 7745HX RTX 4070 16GB RAM 1TB SSD Gaming Laptop",
        "Computers&Accessories",
        "HP",
        129999,
        149999,
    ...
    (
        "hp-004",
        "HP ProBook 440 G10 Intel Core i5 13th Gen 8GB RAM 512GB SSD Business Laptop",
        "Computers&Accessories",
        "HP",
        58990,
        68990,
    ...
    (
        "hp-005",
        "HP 15s Intel Core i5 13th Gen 8GB RAM 512GB SSD Laptop",
        "Computers&Accessories",
        "HP",
        47990,
        54990,
    ...
    (
        "hp-006",
        "HP Laptop 14s AMD Ryzen 3 7320U 8GB RAM 512GB SSD",
        "Computers&Accessories",
        "HP",
        36990,
        42990,
    ...
    (
        "dell-001",
        "Dell XPS 13 Intel Core i7 13th Gen 16GB RAM 512GB SSD 13.4-inch Laptop",
        "Computers&Accessories",
        "Dell",
        134999,
        154999,
    ...
    (
        "dell-002",
        "Dell Vostro 15 3530 Intel Core i5 13th Gen 8GB RAM 512GB SSD Laptop",
        "Computers&Accessories",
        "Dell",
        48990,
        56990,
    ...
    (
        "dell-003",
        "Dell G15 5530 Intel Core i7 13th Gen RTX 4060 16GB RAM 512GB SSD Gaming Laptop",
        "Computers&Accessories",
        "Dell",
        89999,
        104999,
    ...
    (
        "dell-004",
        "Dell G16 7630 Intel Core i9 13th Gen RTX 4070 32GB RAM 1TB SSD Gaming Laptop",
        "Computers&Accessories",
        "Dell",
        149999,
        174999,
    ...
    (
        "dell-005",
        "Dell Inspiron 16 Intel Core i7 13th Gen 16GB RAM 512GB SSD 2-in-1 Laptop",
        "Computers&Accessories",
        "Dell",
        89999,
        104999,
    ...
    (
        "dell-006",
        "Dell Latitude 7440 Intel Core i5 13th Gen 16GB RAM 512GB SSD Business Laptop",
        "Computers&Accessories",
        "Dell",
        99999,
        114999,
    ...
    (
        "len-001",
        "Lenovo Legion 5 AMD Ryzen 7 7745HX RTX 4060 16GB RAM 512GB SSD Gaming Laptop",
        "Computers&Accessories",
        "Lenovo",
        89999,
        104999,
    ...
    (
        "len-002",
        "Lenovo Legion 5 Pro AMD Ryzen 9 7945HX RTX 4070 32GB RAM 1TB SSD Gaming Laptop",
        "Computers&Accessories",
        "Lenovo",
        139999,
        164999,
    ...
    (
        "len-003",
        "Lenovo Yoga Slim 7i Intel Core Ultra 5 16GB RAM 512GB SSD 14-inch Laptop",
        "Computers&Accessories",
        "Lenovo",
        84999,
        99999,
    ...
    (
        "len-004",
        "Lenovo IdeaPad 5 Pro AMD Ryzen 7 8845HS 16GB RAM 512GB SSD 16-inch Laptop",
        "Computers&Accessories",
        "Lenovo",
        79999,
        94999,
    ...
    (
        "len-005",
        "Lenovo LOQ 15 Intel Core i5 13th Gen RTX 4050 8GB RAM 512GB SSD Gaming Laptop",
        "Computers&Accessories",
        "Lenovo",
        64999,
        76999,
    ...
    (
        "len-006",
        "Lenovo ThinkBook 15 Intel Core i5 13th Gen 16GB RAM 512GB SSD Business Laptop",
        "Computers&Accessories",
        "Lenovo",
        62990,
        74990,
    ...
    (
        "op-001",
        "OnePlus 11 5G 8GB RAM 128GB Titan Black",
        "Electronics",
        "OnePlus",
        56999,
        61999,
    ...
    (
        "op-002",
        "OnePlus 11R 5G 8GB RAM 128GB Sonic Black",
        "Electronics",
        "OnePlus",
        39999,
        44999,
    ...
    (
        "op-003",
        "OnePlus Nord 3 5G 8GB RAM 128GB Misty Green",
        "Electronics",
        "OnePlus",
        33999,
        37999,
    ...
    (
        "op-004",
        "OnePlus Nord CE 3 5G 8GB RAM 128GB Aqua Surge",
        "Electronics",
        "OnePlus",
        26999,
        29999,
    ...
    (
        "op-005",
        "OnePlus Nord CE 3 Lite 5G 8GB RAM 128GB Pastel Lime",
        "Electronics",
        "OnePlus",
        19999,
        22999,
    ...
    (
        "op-006",
        "OnePlus Nord CE 4 5G 8GB RAM 256GB Celadon Marble",
        "Electronics",
        "OnePlus",
        24999,
        28999,
    ...
    (
        "op-007",
        "OnePlus 12 16GB RAM 512GB Flowy Emerald",
        "Electronics",
        "OnePlus",
        74999,
        84999,
    ...
    (
        "boat-001",
        "boAt Airdopes 800 ANC Active Noise Cancellation TWS Earbuds",
        "Electronics",
        "boAt",
        3499,
        5999,
    ...
    (
        "boat-002",
        "boAt Airdopes 500 ANC True Wireless Earbuds",
        "Electronics",
        "boAt",
        2499,
        4499,
    ...
    (
        "boat-003",
        "boAt Airdopes 400 TWS Earbuds with 40H Playtime",
        "Electronics",
        "boAt",
        1299,
        2499,
    ...
    (
        "boat-004",
        "boAt Rockerz 600 ANC Wireless Headphones",
        "Electronics",
        "boAt",
        2499,
        4499,
    ...
    (
        "boat-005",
        "boAt Rockerz 551 ANC Wireless Headphones 80H Battery",
        "Electronics",
        "boAt",
        1999,
        3999,
    ...
    (
        "boat-006",
        "boAt Airdopes 131 True Wireless Earbuds 8mm Drivers",
        "Electronics",
        "boAt",
        999,
        1999,
    ...
    (
        "boat-007",
        "boAt Airdopes 441 v2 True Wireless Earbuds 42H Playback",
        "Electronics",
        "boAt",
        1499,
        2999,
    ...
    (
        "boat-008",
        "boAt Rockerz 255 ANC Neckband Bluetooth Earphones",
        "Electronics",
        "boAt",
        1599,
        2999,
    ...
    (
        "boat-009",
        "boAt Rockerz 480 Over Ear Bluetooth Headphones",
        "Electronics",
        "boAt",
        1599,
        2999,
    ...
    (
        "boat-010",
        "boAt Stone 650 Portable Bluetooth Speaker 10W",
        "Electronics",
        "boAt",
        1499,
        2999,
    ...
    (
        "boat-011",
        "boAt Airdopes 181 Pro ANC True Wireless Earbuds",
        "Electronics",
        "boAt",
        1899,
        3499,
...
REVIEWS = {
    "apple-001": [
        (
            ...
            "AirPods Pro 2 ANC is exceptional. Transparency mode sounds natural. H2 chip shows.",
            5.0,
        ),
    ...
    "apple-010": [
        (
            "Ultimate adventure watch",
            "Precision GPS is incredibly accurate. 36-hour battery is real. Action Button.",
            5.0,
        ),
    ...
    "apple-011": [
        ...
        (
            "Perfect everyday smartwatch",
            "Everything an Apple Watch should be at a fair price. Health features great.",
            4.5,
        ),
    ],
    "sam-s24-001": [
    ...
    "sony-h-003": [
        ...
        (
            "Amazing lightweight headphone",
            "192g is feather-light. 3-minute quick charge for 60 mins is a lifesaver.",
            4.5,
        ),
    ],
    "sony-h-004": [
        (
            "Best budget Sony headphone",
            "50-hour battery is hard to believe. Sound quality is excellent for price.",
            4.5,
        ),
    ...
    "op-007": [
        ...
        (
            "Best flagship OnePlus",
            "64MP periscope zoom delivers exceptional detail. Hasselblad colours are great.",
            4.5,
        ),
    ],
    "boat-001": [
