...
PRODUCTS = [
    ...
    # PRESSURE COOKERS
    # ══════════════════════════════════════════════
    ("pc-001", "Prestige Deluxe Plus Outer Lid Pressure Cooker 5 Litre Aluminium",
     "Home&Kitchen", "Prestige", 1195, 1695, "30%", 4.4, "28,432",
     "Hard anodized aluminium, pressure indicator, safety plug, Teflon coated. Most popular Indian pressure cooker."),

    ("pc-002", "Hawkins Stainless Steel Pressure Cooker 5 Litre",
     "Home&Kitchen", "Hawkins", 2499, 3199, "22%", 4.5, "14,321",
     "Food-grade stainless steel, tri-ply base, even heat distribution, 5-year warranty. Premium build quality."),

    ("pc-003", "Prestige Popular Aluminium Pressure Cooker 3 Litre",
     "Home&Kitchen", "Prestige", 845, 1195, "29%", 4.3, "32,543",
     "Lightweight aluminium, sturdy lid, pressure indicator, safety valve, 1-year warranty. Best budget cooker."),

    ("pc-004", "Butterfly Blue Line Aluminium Pressure Cooker 5 Litre",
     "Home&Kitchen", "Butterfly", 999, 1399, "29%", 4.3, "18,765",
     "Outer lid design, aluminium body, pressure indicator, gasket release system. Trusted South Indian brand."),

    ("pc-005", "Vinod Stainless Steel Pressure Cooker 5 Litre Inner Lid",
     "Home&Kitchen", "Vinod", 2195, 2895, "24%", 4.4, "9,876",
     "Triply stainless steel, induction compatible, dishwasher safe, ISI certified. Premium cooking performance."),

    ("pc-006", "Instant Pot Duo 5.7L 7-in-1 Multi-Use Electric Pressure Cooker",
     "Home&Kitchen", "Instant", 9995, 14995, "33%", 4.6, "8,432",
     "Pressure cook, slow cook, rice, saute, steam, warm, yoghurt. 14 smart programs, UL certified. Best electric cooker."),

    ("pc-007", "Hawkins Futura Pressure Cooker 3 Litre Hard Anodized",
     "Home&Kitchen", "Hawkins", 2095, 2795, "25%", 4.5, "7,654",
     "Hard anodized, non-stick interior, outer lid, encapsulated bottom. Great for induction cooktops."),

    ("pc-008", "TTK Prestige Manttra 5 Litre Aluminium Pressure Cooker",
     "Home&Kitchen", "Prestige", 1345, 1895, "29%", 4.2, "11,234",
     "Anti-bulge lid, safety valve, ISI mark, aluminium body. Ideal for medium-size families."),

    ("pc-009", "Pigeon by Stovekraft Junior 3 Litre Aluminium Pressure Cooker",
     "Home&Kitchen", "Pigeon", 695, 995, "30%", 4.2, "22,543",
     "Lightweight aluminium, hard anodized, pressure indicator. Best budget cooker under ₹700."),

    ("pc-010", "Prestige Svachh 5 Litre Inner Lid Pressure Cooker with Deep Lid",
     "Home&Kitchen", "Prestige", 1795, 2395, "25%", 4.5, "13,210",
    ...
    # ══════════════════════════════════════════════
    ("wb-001", "Milton Thermosteel Flip Lid Flask 1000ml Insulated Water Bottle",
     "Home&Kitchen", "Milton", 849, 1295, "34%", 4.4, "31,234",
     "Double-wall vacuum insulation, keeps hot 24hr / cold 24hr, food-grade stainless steel, leak-proof flip lid."),

    ("wb-002", "Cello Ozone 1000ml Stainless Steel Vacuum Insulated Water Bottle",
     "Home&Kitchen", "Cello", 599, 899, "33%", 4.3, "24,543",
     "18/8 food-grade stainless steel, vacuum insulated, wide mouth, BPA-free lid. Best value insulated bottle."),

    ("wb-003", "Borosil Hydra Go 1 Litre Vacuum Insulated Sports Water Bottle",
     "Home&Kitchen", "Borosil", 999, 1499, "33%", 4.5, "18,765",
     "18/8 stainless steel, 12hr hot / 24hr cold, leak-proof, lightweight 290g, sports nozzle. Best sports bottle."),

    ("wb-004", "Milton Unify Stainless Steel Hot and Cold Water Bottle 1000ml",
     "Home&Kitchen", "Milton", 549, 799, "31%", 4.3, "28,432",
     "Stainless steel, keeps hot 6hr / cold 24hr, BPA-free, leak-proof. Everyday reliable water bottle."),

    ("wb-005", "Hydro Flask Standard Mouth 621ml Vacuum Insulated Water Bottle",
     "Home&Kitchen", "Hydro Flask", 3495, 4495, "22%", 4.7, "9,876",
     "TempShield double-wall insulation, powder coat exterior, 18/8 pro-grade stainless steel, leakproof. Premium bottle."),

    ("wb-006", "Puma Water Bottle 750ml Sports Bottle with Flip Lid",
     "Home&Kitchen", "Puma", 699, 999, "30%", 4.2, "14,321",
     "BPA-free Tritan plastic, flip top lid, easy grip design, dishwasher safe. Lightweight sports companion."),

    ("wb-007", "Wildcraft Bolt 750ml Sports Water Bottle",
     "Home&Kitchen", "Wildcraft", 599, 849, "29%", 4.3, "12,432",
     "BPA-free material, ergonomic grip, wide mouth for ice cubes, easy clean. Great for gym and outdoors."),

    ("wb-008", "Nalgene Wide Mouth 1L HDPE Water Bottle",
     "Home&Kitchen", "Nalgene", 1295, 1695, "24%", 4.6, "7,654",
     "BPA-free HDPE, dishwasher safe, wide 63mm mouth for ice, lifetime guarantee. Outdoor adventurer favourite."),

    ("wb-009", "Steel Lock Stainless Steel Water Bottle 1L with Carrying Pouch",
     "Home&Kitchen", "Steel Lock", 449, 699, "36%", 4.2, "19,876",
     "Food-grade stainless steel, leak-proof, BPA-free, vacuum insulated, free carrying pouch. Budget pick."),

    ("wb-010", "Camelbak Eddy+ 750ml BPA-Free Water Bottle with Bite Valve",
     "Home&Kitchen", "Camelbak", 1999, 2695, "26%", 4.5, "8,765",
    ...
    # ══════════════════════════════════════════════
    ("cof-001", "Nespresso Essenza Mini by De'Longhi Coffee Machine with 12 Capsules",
     "Home&Kitchen", "Nespresso", 14990, 19990, "25%", 4.6, "8,765",
     "19-bar pressure, 0.6L tank, 15-second heat-up, two cup sizes (espresso & lungo), energy saving. Best pod machine."),

    ("cof-002", "De'Longhi Dedica Style EC685.M Pump Espresso Machine",
     "Home&Kitchen", "De'Longhi", 22990, 29990, "23%", 4.6, "5,432",
     "15-bar pump, thermoblock heating, manual milk frother, 3 filter options. Professional espresso at home."),

    ("cof-003", "Morphy Richards New Europa 800W Espresso and Cappuccino Coffee Maker",
     "Home&Kitchen", "Morphy Richards", 5499, 7499, "27%", 4.3, "12,321",
     "800W, 4-cup capacity, steam nozzle for frothing milk, fast brewing, detachable drip tray."),

    ("cof-004", "Preethi Cafe Zest CM210 600W Drip Coffee Maker",
     "Home&Kitchen", "Preethi", 2299, 3299, "30%", 4.3, "9,876",
     "600W, 6-cup glass carafe, permanent filter, anti-drip, keep-warm plate, borosilicate glass. Reliable brand."),

    ("cof-005", "French Press Coffee Maker 600ml Borosilicate Glass with Double Filter",
     "Home&Kitchen", "Bodum", 1299, 1999, "35%", 4.4, "14,543",
     "Borosilicate glass, double mesh filter, chrome plated lid, dishwasher safe, 600ml capacity. Best French press."),

    ("cof-006", "InstaCuppa French Press Coffee Maker 600ml with Thermally Insulated Body",
     "Home&Kitchen", "InstaCuppa", 1499, 2299, "35%", 4.5, "11,234",
     "Stainless steel thermal body, dual-wall insulation, triple filter system, 600ml. Best insulated French press."),

    ("cof-007", "Kaapi Machines BUDAN Automatic Pour Over Coffee Machine",
     "Home&Kitchen", "Kaapi Machines", 8999, 11999, "25%", 4.4, "3,210",
     "1.2L capacity, shower head for even extraction, keep warm plate, programmable. Best pour-over machine."),

    ("cof-008", "Nespresso Vertuo Pop Coffee Machine with Aeroccino3 Milk Frother",
     "Home&Kitchen", "Nespresso", 18990, 23990, "21%", 4.7, "4,321",
    ...
    # ══════════════════════════════════════════════
    ("mw-001", "LG 20L Solo Microwave Oven MS2043DB",
     "Home&Kitchen", "LG", 7490, 9990, "25%", 4.3, "18,432",
     "20L capacity, 700W, 5 power levels, smart diagnosis, child lock, 1-year warranty. Best solo microwave."),

    ("mw-002", "Samsung 20L Solo Microwave Oven MS20A3010AL",
     "Home&Kitchen", "Samsung", 7990, 10990, "27%", 4.3, "14,321",
     "20L, 1150W, easy clean coating, ceramic enamel interior, 5 power levels, defrost. Reliable solo microwave."),

    ("mw-003", "Panasonic 20L Solo Microwave Oven NN-ST26JMFDG",
     "Home&Kitchen", "Panasonic", 7990, 10990, "27%", 4.4, "11,234",
     "20L, 800W, 10 power levels, auto cook menu, child lock, 360-degree turntable. Japanese precision."),

    ("mw-004", "IFB 23L Grill Microwave Oven 23PG4B",
     "Home&Kitchen", "IFB", 8990, 11990, "25%", 4.4, "12,543",
     "23L, grill + microwave combo, stainless steel cavity, 51 autocook menus, steam clean. Best grill microwave."),

    ("mw-005", "LG 21L Grill Microwave Oven MH2144DB",
     "Home&Kitchen", "LG", 8490, 10990, "23%", 4.3, "9,876",
     "21L, 700W microwave + grill, EasyClean, quartz heater for crispy grilling, child lock. Good grill microwave."),

    ("mw-006", "Godrej 20L Convection Microwave Oven GME 720 CF1 PZ",
     "Home&Kitchen", "Godrej", 9499, 12999, "27%", 4.2, "7,654",
    ...
    # ══════════════════════════════════════════════
    ("bl-001", "Philips HL7575/00 600W Hand Blender with Whisk and Chopper",
     "Home&Kitchen", "Philips", 3295, 4895, "33%", 4.4, "11,234",
     "600W ProMix technology, 2-speed settings, detachable arm, dishwasher safe, 500ml chopper. Best hand blender."),

    ("bl-002", "Bosch MSM66150 600W Hand Blender with Blending Wand",
     "Home&Kitchen", "Bosch", 3499, 4999, "30%", 4.5, "8,765",
     "600W, ErgoMixx grip, 2-speed + turbo, dishwasher safe attachment, QuattroBlade technology. German precision."),

    ("bl-003", "Nutribullet 900W Personal Blender for Nutrient Extraction",
     "Home&Kitchen", "Nutribullet", 5999, 7999, "25%", 4.5, "7,654",
     "900W motor, extractor blade pulverises seeds & stems, 600ml cup with flip-top lid. Best smoothie blender."),

    ("bl-004", "Sujata Powermatic Plus 900W Juicer Mixer Grinder with Blender Jar",
     "Home&Kitchen", "Sujata", 5890, 7890, "25%", 4.5, "9,876",
    ...
    # ══════════════════════════════════════════════
    ("jcr-001", "Philips HR1832/00 Viva Collection Juicer 500W",
     "Home&Kitchen", "Philips", 2995, 3995, "25%", 4.3, "12,543",
     "500W, 1L pulp container, 2-speed, QuickClean technology, extra wide tube. Trusted Philips centrifugal juicer."),

    ("jcr-002", "Hurom H-AA Slow Juicer 150W Cold Press Juicer",
     "Home&Kitchen", "Hurom", 18999, 24999, "24%", 4.6, "3,210",
     "150W, slow squeeze technology, 60RPM, preserves nutrients, fine/coarse strainer, quiet operation. Best cold press."),

    ("jcr-003", "Kuvings Whole Slow Juicer EVO820 240W",
     "Home&Kitchen", "Kuvings", 22999, 28999, "21%", 4.7, "2,543",
    ...
    # ══════════════════════════════════════════════
    ("tst-001", "Philips HD2582/00 2-Slice Pop-Up Toaster 830W",
     "Home&Kitchen", "Philips", 1995, 2795, "29%", 4.4, "18,432",
     "830W, 7 browning settings, reheat/defrost/cancel, extra wide slots, removable crumb tray. Best pop-up toaster."),

    ("tst-002", "Bajaj ATX 4 2-Slice Pop-Up Toaster",
     "Home&Kitchen", "Bajaj", 1295, 1795, "28%", 4.3, "22,543",
     "700W, 7 settings, cancel/reheat/defrost, high lift, removable crumb tray, 2-year warranty. Best budget toaster."),

    ("tst-003", "Prestige PPTPKB 800W Pop-Up Toaster with 2 Slice",
     "Home&Kitchen", "Prestige", 1195, 1695, "30%", 4.2, "16,543",
     "800W, 6 browning levels, extra-wide slots, anti-jam function, slide-out crumb tray. Trusted Prestige brand."),

    ("tst-004", "Bajaj Majesty New SWX 9 2-in-1 Grill Sandwich Maker and Toaster",
     "Home&Kitchen", "Bajaj", 1299, 1799, "28%", 4.3, "24,321",
     "750W, 2-in-1 sandwich + grilling, non-stick plates, cool touch handle, indicator light. Best sandwich toaster."),

    ("tst-005", "Prestige PGMFB 800W Grill Sandwich Maker with Non-Stick Plates",
     "Home&Kitchen", "Prestige", 1399, 1999, "30%", 4.4, "19,876",
     "800W, non-stick coating, floating hinge, indicator light, cool touch body. Great family sandwich maker."),

    ("tst-006", "Philips HD2145/40 Daily Collection Sandwich Maker 820W",
     "Home&Kitchen", "Philips", 1795, 2395, "25%", 4.5, "14,321",
...
REVIEWS = {
    "pc-001": [
        ("Best pressure cooker for everyday use", "Prestige quality is legendary. Hard anodized surface is very durable.", 4.5),
    ...
    "pc-005": [
        ("Best stainless steel cooker", "Triply base makes huge difference in even cooking. Induction compatible.", 4.5),
    ...
    "pc-007": [
        ("Best small pressure cooker", "3L hard anodized Hawkins is perfect for smaller families. Induction ready.", 4.5),
    ...
    "cof-004": [
        ("Best Indian drip coffee maker", "Preethi brand is well-known in South India. Makes great filter coffee.", 4.5),
    ...
    "cof-007": [
        ("Best pour-over machine", "Kaapi Machines is a great Indian brand. Even extraction produces great coffee.", 4.5),
        ("Great for coffee enthusiasts", "Shower head design is key for even brewing. Makes café-quality filter coffee.", 4.0),
    ],
    "cof-008": [
    ...
    "mw-004": [
        ("Best grill microwave", "IFB grill function produces crispy results. 51 autocook menus cover Indian food.", 4.5),
    ...
    "mw-006": [
        ("Good Indian brand microwave", "200 autocook menus specifically designed for Indian cooking is excellent.", 4.0),
    ...
    "tst-001": [
        ("Best pop-up toaster", "Philips 7 browning settings give perfect control. Extra wide slots fit thick bread.", 4.5),
