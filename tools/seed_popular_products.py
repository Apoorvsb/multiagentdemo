...
PRODUCTS = [
    ...
    (
        "lap-001",
        "Dell Inspiron 15 Intel Core i5 12th Gen 8GB RAM 512GB SSD Laptop",
    ...
    (
        "lap-002",
        "Lenovo IdeaPad Slim 3 AMD Ryzen 5 7520U 8GB RAM 512GB SSD Laptop",
        "Computers&Accessories",
        "Lenovo",
        45990,
        52990,
    ...
    (
        "lap-003",
        "ASUS VivoBook 15 Intel Core i3 12th Gen 8GB RAM 256GB SSD Laptop",
        "Computers&Accessories",
        "ASUS",
        34990,
        39990,
    ...
    (
        "lap-004",
        "HP Pavilion 14 Intel Core i5 13th Gen 16GB RAM 512GB SSD Laptop",
        "Computers&Accessories",
        "HP",
        63490,
        72990,
    ...
    (
        "lap-005",
        "Apple MacBook Air M2 Chip 8GB RAM 256GB SSD 13-inch Laptop",
        "Computers&Accessories",
        "Apple",
        99900,
        114900,
    ...
    (
        "lap-006",
        "Acer Nitro 5 AMD Ryzen 5 7535HS RTX 2050 8GB RAM 512GB SSD Gaming Laptop",
        "Computers&Accessories",
        "Acer",
        62990,
        74990,
    ...
    (
        "lap-007",
        "ASUS ROG Strix G15 AMD Ryzen 9 16GB RAM 1TB SSD RTX 4060 Gaming Laptop",
        "Computers&Accessories",
        "ASUS",
        119990,
        139990,
    ...
    (
        "lap-008",
        "Lenovo ThinkPad E14 Intel Core i5 13th Gen 16GB RAM 512GB SSD Business Laptop",
        "Computers&Accessories",
        "Lenovo",
        68990,
        79990,
    ...
    (
        "lap-009",
        "Mi Notebook 14 Intel Core i5 10th Gen 8GB RAM 256GB SSD Thin & Light Laptop",
        "Computers&Accessories",
        "Mi",
        41990,
        49990,
    ...
    (
        "lap-010",
        "HP Victus 15 AMD Ryzen 5 7535HS RTX 3050 8GB RAM 512GB SSD Gaming Laptop",
        "Computers&Accessories",
        "HP",
        67990,
        79990,
    ...
    (
        "ac-001",
        "Daikin 1.5 Ton 5 Star Wi-Fi Inverter Split AC with PM 0.1 Filter",
        "Electronics",
        "Daikin",
        46490,
        52990,
    ...
    (
        "ac-002",
        "LG 1.5 Ton 5 Star DUAL Inverter Split AC with 4 in 1 Convertible Cooling",
        "Electronics",
        "LG",
        43990,
        51990,
    ...
    (
        "ac-004",
        "Samsung 1.5 Ton 5 Star Wi-Fi Inverter Split AC with Wind-Free Cooling",
        "Electronics",
        "Samsung",
        47990,
        55990,
    ...
    (
        "ac-006",
        "Voltas 1.5 Ton 5 Star Inverter Split AC with Adjustable Inverter",
        "Electronics",
        "Voltas",
        41990,
        48990,
    ...
    (
        "ac-007",
        "LG 2 Ton 5 Star Wi-Fi Inverter Split AC with Convertible 6-in-1 Cooling",
        "Electronics",
        "LG",
        56990,
        64990,
    ...
    (
        "ac-008",
        "Carrier 1.5 Ton 3 Star Split AC with PM 2.5 Filter",
        "Electronics",
        "Carrier",
        31990,
        37990,
    ...
    (
        "ac-009",
        "Panasonic 1.5 Ton 5 Star Wi-Fi Inverter Split AC with 7-in-1 Convertible",
        "Electronics",
        "Panasonic",
        44990,
        52990,
    ...
    (
        "ac-010",
        "Hitachi 1.5 Ton 3 Star Inverter Split AC with Auto Changeable Filter",
        "Electronics",
        "Hitachi",
        35490,
        41990,
    ...
    (
        "tv-001",
        "Samsung 43-inch Crystal 4K UHD Smart TV with AirSlim Design",
        "Electronics",
        "Samsung",
        32990,
        42900,
    ...
    (
        "tv-002",
        "LG 43-inch 4K UHD Smart LED TV with WebOS 23",
        "Electronics",
        "LG",
        34990,
        44990,
    ...
    (
        "tv-003",
        "Sony Bravia 43-inch 4K UHD Google TV with Triluminos Pro",
        "Electronics",
        "Sony",
        44990,
        59990,
    ...
    (
        "tv-004",
        "MI 55-inch 4K Ultra HD Smart Android TV with Vivid Picture Engine",
        "Electronics",
        "MI",
        31999,
        45999,
    ...
    (
        "tv-005",
        "TCL 55-inch QLED 4K Google TV with Hands-Free Voice Control",
        "Electronics",
        "TCL",
        39990,
        54990,
    ...
    (
        "tv-006",
        "Hisense 50-inch 4K ULED QLED Smart Google TV",
        "Electronics",
        "Hisense",
        35990,
        48990,
    ...
    (
        "ph-001",
        "Samsung Galaxy S23 FE 5G 8GB RAM 256GB Storage Dual SIM",
        "Electronics",
        "Samsung",
        39999,
        49999,
    ...
    (
        "ph-002",
        "OnePlus 12R 5G 8GB RAM 128GB Storage",
        "Electronics",
        "OnePlus",
        39999,
        44999,
    ...
    (
        "ph-003",
        "Redmi Note 13 5G 8GB RAM 256GB Storage",
        "Electronics",
        "Redmi",
        19999,
        24999,
    ...
    (
        "ph-004",
        "Realme Narzo 60 Pro 5G 8GB RAM 128GB Storage",
        "Electronics",
        "Realme",
        17999,
        22999,
    ...
    (
        "ph-006",
        "Motorola Edge 40 Neo 5G 8GB RAM 256GB Storage",
        "Electronics",
        "Motorola",
        19999,
        25999,
    ...
    (
        "rf-001",
        "LG 242L 3 Star Smart Inverter Double Door Refrigerator",
        "Electronics",
        "LG",
        26990,
        32990,
    ...
    (
        "rf-002",
        "Samsung 253L 3 Star Digital Inverter Double Door Refrigerator",
        "Electronics",
        "Samsung",
        27490,
        33990,
    ...
    (
        "rf-003",
        "Whirlpool 265L 3 Star Frost-Free Double Door Refrigerator",
        "Electronics",
        "Whirlpool",
        26490,
        31990,
    ...
    (
        "wm-001",
        "LG 7kg 5 Star Inverter Fully Automatic Front Load Washing Machine",
        "Electronics",
        "LG",
        34990,
        42990,
    ...
    (
        "wm-002",
        "Samsung 7kg 5 Star Inverter Fully Automatic Top Load Washing Machine",
        "Electronics",
        "Samsung",
        19990,
        25990,
    ...
    (
        "kit-001",
        "Philips HL7756/00 750W Mixer Grinder with 4 Jars",
        "Home&Kitchen",
        "Philips",
        3295,
        4495,
    ...
    (
        "kit-002",
        "Prestige Iris 550W Mixer Grinder with 3 Stainless Steel Jars",
        "Home&Kitchen",
        "Prestige",
        1799,
        2499,
    ...
    (
        "kit-003",
        "Bajaj Rex 500W Mixer Grinder with 3 Jars",
        "Home&Kitchen",
        "Bajaj",
        1449,
        1999,
    ...
    (
        "kit-004",
        "LG 28L NeoChef Convection Microwave Oven",
        "Home&Kitchen",
        "LG",
        17490,
        21990,
    ...
    (
        "kit-005",
        "Samsung 28L Convection Microwave Oven with SlimFry",
        "Home&Kitchen",
        "Samsung",
        16490,
        20990,
    ...
    (
        "kit-006",
        "IFB 25L Convection Microwave Oven with Multi-Stage Cooking",
        "Home&Kitchen",
        "IFB",
        11490,
        14990,
    ...
    (
        "kit-007",
        "Philips HD9252/90 Air Fryer with Rapid Air Technology",
        "Home&Kitchen",
        "Philips",
        7995,
        11995,
    ...
    (
        "kit-008",
        "Instant Vortex 4-in-1 Air Fryer 5.7L with EvenCrisp Technology",
        "Home&Kitchen",
        "Instant",
        8495,
        10995,
    ...
    (
        "kit-009",
        "Tefal Easy Fry Classic+ 4.2L Air Fryer with XL Pan",
        "Home&Kitchen",
        "Tefal",
        6995,
        9495,
    ...
    (
        "kit-010",
        "Prestige PKOSS 1.8L Electric Kettle 1500W",
        "Home&Kitchen",
        "Prestige",
        999,
        1499,
    ...
    (
        "kit-011",
        "Philips HD9306/06 Electric Kettle 1.7L 2400W",
        "Home&Kitchen",
        "Philips",
        1495,
        2195,
    ...
    (
        "kit-012",
        "Bajaj Majesty ICX 3 1900W Induction Cooktop",
        "Home&Kitchen",
        "Bajaj",
        1699,
        2499,
    ...
    (
        "kit-013",
        "Philips Viva Collection HD4928/01 2100W Induction Cooktop",
        "Home&Kitchen",
        "Philips",
        2495,
        3495,
    ...
    (
        "kit-014",
        "Kent Grand Plus 9L RO+UV+UF+TDS Water Purifier",
        "Home&Kitchen",
        "Kent",
        14999,
        19999,
    ...
    (
        "kit-015",
        "Aquaguard Aura NXT 7L RO+UV+SS+MTDS Water Purifier",
        "Home&Kitchen",
        "Aquaguard",
        13999,
        18499,
    ...
    (
        "kit-016",
        "Havells Diamo 7L RO+UV Water Purifier with Alkaline Water",
        "Home&Kitchen",
        "Havells",
        11999,
        15999,
    ...
    (
        "kit-017",
        "Prestige PRCK 6.0 L Electric Rice Cooker",
        "Home&Kitchen",
        "Prestige",
        1299,
        1999,
    ...
    (
        "kit-018",
        "Panasonic SR-WA18H 4.4L Automatic Rice Cooker",
        "Home&Kitchen",
        "Panasonic",
        1995,
        2795,
    ...
    (
        "mon-001",
        "LG 24MP400-B 24-inch Full HD IPS Monitor with AMD FreeSync",
        "Computers&Accessories",
        "LG",
        8999,
        11999,
    ...
    (
        "mon-002",
        "Samsung 24-inch FHD IPS Ultra Slim Monitor with Eye Saver Mode",
        "Computers&Accessories",
        "Samsung",
        9999,
        13499,
    ...
    (
        "mon-003",
        "Dell 27-inch QHD IPS Monitor with USB-C and 165Hz",
        "Computers&Accessories",
        "Dell",
        26990,
        35990,
    ...
    (
        "prt-001",
        "HP Ink Tank 315 Multi-Function Colour Printer",
        "Computers&Accessories",
        "HP",
        9499,
        12999,
    ...
    (
        "prt-003",
        "Canon PIXMA G3020 NX All-in-One Wi-Fi Ink Tank Printer",
        "Computers&Accessories",
        "Canon",
        10499,
        13999,
...
REVIEWS = {
    "lap-001": [
        (
            ...
            "Fast boot, smooth multitasking. Battery lasts 7+ hours. Great buy for the price.",
            4.5,
        ),
    ...
    "ac-004": [
        (
            "Smart AC done right",
            "WindFree cooling is a revelation — no direct cold air blast. AI mode works well.",
            4.5,
        ),
    ...
    "tv-003": [
        (
            "Sony picture quality is unmatchable",
            "Triluminos Pro makes every frame look cinematic. Worth the premium.",
            5.0,
        ),
    ...
    "kit-005": [
        (
            "Feature-packed Samsung microwave",
            "SlimFry is a great feature for low-oil cooking. 15 auto cook menus cover all.",
            4.5,
        ),
    ...
    "kit-013": [
        (
            "Excellent Philips induction",
            "2100W heats instantly. Child lock gives peace of mind. Keep warm is useful.",
            4.5,
        ),
    ...
    with get_conn() as conn:
        with conn.cursor() as cur:
            ...
            for label, kw in [
                ...
                cur.execute("SELECT COUNT(*) FROM products WHERE name ILIKE %s", [f"%{kw}%"])
