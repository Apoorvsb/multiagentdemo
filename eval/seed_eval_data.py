...
TRACKING_EVENTS = {
    "EK101401": {
        "carrier": "Ekart", "location": "Bangalore Hub", "status": "DELIVERED",
        "last_update": "2024-01-06T10:00:00Z", "eta": "2024-01-06T00:00:00Z",
        "events": [
        ...
        "days_real": 1, "days_sched": 1, "delivery_status": "Advance shipping",
        "ship_date": "2024-01-05",
    },
    "FX101419": {
        "carrier": "FedEx", "location": "Kolkata Gateway", "status": "IN_TRANSIT",
        "last_update": "2024-04-10T08:00:00Z", "eta": "2024-04-11T00:00:00Z",
        "events": [
        ...
        "days_real": 3, "days_sched": 3, "delivery_status": "Advance shipping",
        "ship_date": "2024-04-09",
    },
    "DL101437": {
        "carrier": "Delhivery", "location": "Chennai Hub", "status": "PENDING",
        "last_update": "2024-06-07T10:00:00Z", "eta": "2024-06-08T00:00:00Z",
        "events": [
    ...
    "DL101455": {
        "carrier": "Delhivery", "location": "Mumbai Hub", "status": "DELIVERED",
        "last_update": "2024-03-05T11:00:00Z", "eta": "2024-03-05T00:00:00Z",
        "events": [
        ...
        "days_real": 5, "days_sched": 5, "delivery_status": "Advance shipping",
        "ship_date": "2024-03-01",
    },
    "DL101473": {
        "carrier": "Delhivery", "location": "Delhi Distribution Center", "status": "OUT_FOR_DELIVERY",
        "last_update": "2024-04-23T08:00:00Z", "eta": "2024-04-23T00:00:00Z",
        "events": [
    ...
    "DL101491": {
        "carrier": "Delhivery", "location": "Chennai Hub", "status": "IN_TRANSIT",
        "last_update": "2024-05-26T08:00:00Z", "eta": "2024-05-28T00:00:00Z",
        "events": [
        ...
        with conn.cursor() as cur:
            ...
            for o in EVAL_ORDERS:
                cur.execute(
                    ...
                    [
                        o["order_id"], EVAL_USER, o["customer_name"], o["status"],
                        o["carrier"], o["tracking_number"], o["estimated_delivery"],
                        psycopg2.extras.Json(o["items"]), o["shipping_mode"],
                        "South Asia", "India", o["order_city"], "Pacific Asia",
                        0, 50.0, 500.0, o["order_date"],
                    ],
                )
            ...
            for tn, t in TRACKING_EVENTS.items():
                cur.execute(
                    ...
                    [
                        tn, t["carrier"], t["location"], t["status"],
                        t["last_update"], t["eta"],
